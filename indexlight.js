...
const { axios } = require("axios"); // 👈 necessário para instanciar o wallet

const SYMBOL = process.env.SYMBOL || "satoshi";
const NETWORK = process.env.NETWORK || "lightning network";
